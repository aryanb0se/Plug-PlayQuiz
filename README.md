...
A tiny, delightfully chaotic browser-based quiz app where questions come in like a cassette tape and your brain has to survive the playback. It’s built with plain HTML, CSS, and JavaScript, which is basically the web equivalent of making a sandwich with whatever is in the fridge: simple, effective, and somehow still kind of impressive.
...
Basically, it turns “I should study” into “I have to become emotionally invested in prime numbers.”
...
```text
PlugNPlay/
├── app.js              # Core quiz logic and rendering
├── index.html          # App entry point
├── styles.css          # Retro cassette visual design and layout
├── palisades_quiz.json # Example exam data
├── README.md           # This glorious masterpiece
└── .gitignore          # Optional project ignore file if you add one later
```

## Run it locally

Because this is a static site, you do not need a big framework, a backend, or a dramatic startup ritual.
...
### Option 2: Just open the HTML file

You can also open `index.html` directly in a browser, but local hosting is smoother and less weird.
...
This project is perfect for GitHub Pages because it is a static site.
...
5. Set the root folder to `/` (or root)
6. Save
7. Wait for GitHub to build the site

Then your app will be live at something like:

```text
https://<your-username>.github.io/<your-repo-name>/
```

This means anyone with internet access can use your quiz app without installing anything. That is the dream. That is the future. That is how we avoid pretending the internet is not a circus.
